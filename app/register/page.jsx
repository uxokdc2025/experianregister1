...
const BIco = {
  ...
  globe: () => <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="8.5" stroke="#00A651" strokeWidth="1.8"/><path d="M3.5 12h17M12 3.5c2.5 2.4 2.5 14.6 0 17M12 3.5c-2.5 2.4-2.5 14.6 0 17" stroke="#00A651" strokeWidth="1.6"/></svg>,
...
function BenefitProtection() {
  return (
    <>
      <SlideHead badge="ALWAYS ON" title="Protection that never sleeps watching 24/7" sub="We scan the dark web, monitor your credit file, and put you back in control the instant anything looks wrong - all free." />
...
function BenefitFico() {
  return (
    <>
      <SlideHead badge="FREE FOREVER" title="Know your real FICO Score the one lenders actually use" sub="Get your free Experian credit report and FICO Score 8, the same score 90% of top lenders use , updated daily at no cost." />
...
function BenefitBoost() {
  return (
    <>
      <SlideHead badge="EXPERIAN BOOST" title="Raise your score just by paying the bills you already pay" sub="Connect your bank account and we'll find rent, utilities streaming , and phone payments that can lift your FICO Score instantly." />
      <BoostChart />
