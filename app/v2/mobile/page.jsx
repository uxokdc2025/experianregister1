...
function MobileFrame({ children }) {
  return (
    <div style={{ minHeight: '100vh', background: 'var(--color-neutral-100)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24 }}>
      <main id="main-content" style={{ width: MW, height: MH, background: '#fff', borderRadius: 46, boxShadow: '0 40px 90px rgba(13,13,31,.40)', overflow: 'hidden', position: 'relative', flexShrink: 0 }}>
        {children}
        <div aria-hidden="true" style={{ position: 'absolute', bottom: 8, left: '50%', transform: 'translateX(-50%)', width: 134, height: 5, borderRadius: 9999, background: 'rgba(13,13,31,.22)', pointerEvents: 'none', zIndex: 40 }} />
      </main>
    </div>
  )
}
...
function FloatInput({ label, value, setValue, type = 'text' }) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      <label htmlFor={inputId} style={{ position: 'absolute', left: 15, top: float ? 9 : '50%', transform: float ? 'none' : 'translateY(-50%)', fontSize: float ? 11 : 15, fontWeight: float ? 700 : 400, color: focus ? PINK : 'var(--color-neutral-500)', pointerEvents: 'none', transition: 'all .15s' }}>{label}</label>
      <input id={inputId} value={value} onChange={e => setValue(e.target.value)} onFocus={() => setFocus(true)} onBlur={() => setFocus(false)} type={type}
  ...
  return (
    <div style={{ flex: half ? 1 : 'none', minWidth: 0 }}>
      <div style={{ border: `1.5px solid ${focus ? PINK : 'var(--color-neutral-200)'}`, borderRadius: 10, padding: '8px 14px 7px', transition: 'border-color .15s' }}>
        <label htmlFor={inputId} style={{ display: 'block', fontSize: 11, fontWeight: 700, color: 'var(--color-neutral-500)' }}>{label}</label>
...
function PromoRow({ title, sub, highlight, delay }) {
  return (
    <div className="intro-rise" style={{ animationDelay: `${delay}s`, display: 'flex', alignItems: 'center', gap: 10, background: highlight ? '#E4E4F3' : '#EDEDF6', borderRadius: 11, padding: '9px 13px' }}>
      {highlight
        ? <svg aria-hidden="true" width="18" height="18" viewBox="0 0 24 24" fill="none" style={{ flexShrink: 0 }}><path d="M12 3l7 2.5v5c0 4.4-3 7.6-7 9-4-1.4-7-4.6-7-9v-5L12 3z" fill={PINK} /><path d="M9 12l2 2 4-4.5" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>
...
function MGauge({ score = 724 }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      <svg aria-hidden="true" width={size} height={arcY + 20}>
...
const Ico = {
  bolt: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M13 2L5 13h6l-1 9 8-11h-6l1-9z" fill={PINK} /></svg>,
  bank: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M12 3l8 4.5H4L12 3z" stroke="#406EB3" strokeWidth="1.7" strokeLinejoin="round" /><path d="M6 10v6M10 10v6M14 10v6M18 10v6M4 19.5h16" stroke="#406EB3" strokeWidth="1.7" strokeLinecap="round" /></svg>,
  trend: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none"><path d="M4 16l5-5 3.5 3.5L20 7" stroke={PINK} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /><path d="M15 7h5v5" stroke={PINK} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  report: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none"><rect x="6" y="4" width="12" height="16" rx="2" stroke="#406EB3" strokeWidth="1.7" /><path d="M9 11h6M9 14.5h4" stroke="#406EB3" strokeWidth="1.7" strokeLinecap="round" /></svg>,
  faster: () => <svg aria-hidden="true" width="24" height="24" viewBox="0 0 26 26" fill="none"><g stroke="#406EB3" strokeWidth="1.8" strokeLinecap="round"><path d="M13 3v3M13 20v3M3 13h3M20 13h3M6 6l2 2M18 18l2 2M20 6l-2 2M8 18l-2 2" /></g></svg>,
  shieldCheck: () => <svg aria-hidden="true" width="24" height="24" viewBox="0 0 26 26" fill="none"><path d="M13 3l8 3v5.5c0 5-3.5 8.8-8 10.5-4.5-1.7-8-5.5-8-10.5V6l8-3z" stroke="#406EB3" strokeWidth="1.8" strokeLinejoin="round" /><path d="M9.5 12.5l2.4 2.4L17 9.8" stroke="#406EB3" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  devices: () => <svg aria-hidden="true" width="24" height="24" viewBox="0 0 26 26" fill="none"><rect x="7" y="3" width="12" height="20" rx="2.5" stroke="#406EB3" strokeWidth="1.8" /><path d="M11 19.5h4" stroke="#406EB3" strokeWidth="1.8" strokeLinecap="round" /></svg>,
  ...
  plus: () => <svg aria-hidden="true" width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 3v10M3 8h10" stroke="var(--color-neutral-500)" strokeWidth="1.7" strokeLinecap="round" /></svg>,
}
