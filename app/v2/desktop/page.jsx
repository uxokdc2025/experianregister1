...
/* ───────────── Icons ───────────── */
const Ico = {
  search: (p) => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none" {...p}><circle cx="9" cy="9" r="6" stroke="currentColor" strokeWidth="1.6"/><path d="M14 14l4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg>,
  chevDown: (p) => <svg aria-hidden="true" width="12" height="12" viewBox="0 0 12 12" fill="none" {...p}><path d="M3 4.5L6 7.5L9 4.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  chevR: (p) => <svg aria-hidden="true" width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}><path d="M5 3l4 4-4 4" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  info: (p) => <svg aria-hidden="true" width="14" height="14" viewBox="0 0 14 14" fill="none" {...p}><circle cx="7" cy="7" r="6" stroke="currentColor" strokeWidth="1.2"/><path d="M7 6.2v3.4M7 4.3v.1" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/></svg>,
}

const TabIco = {
  score: () => <svg aria-hidden="true" width="26" height="26" viewBox="0 0 26 26" fill="none"><path d="M4 17a9 9 0 1118 0" stroke="#406EB3" strokeWidth="2.2" strokeLinecap="round"/><path d="M4 17a9 9 0 014-7.5" stroke="#982881" strokeWidth="2.2" strokeLinecap="round"/><path d="M13 17l4-4.5" stroke="#BA2F7D" strokeWidth="2.2" strokeLinecap="round"/><circle cx="13" cy="17" r="1.8" fill="#26478D"/></svg>,
  bell: () => <svg aria-hidden="true" width="26" height="26" viewBox="0 0 26 26" fill="none"><path d="M13 4a5.5 5.5 0 015.5 5.5v2L20 15H6l1.5-3.5v-2A5.5 5.5 0 0113 4z" stroke="#F5A623" strokeWidth="2" strokeLinejoin="round"/><path d="M10.5 18a2.5 2.5 0 005 0" stroke="#F5A623" strokeWidth="2" strokeLinecap="round"/><circle cx="19" cy="6" r="3" fill="#BA2F7D"/></svg>,
  piggy: () => <svg aria-hidden="true" width="26" height="26" viewBox="0 0 26 26" fill="none"><ellipse cx="11.5" cy="14" rx="8" ry="6.5" stroke="#BA2F7D" strokeWidth="2"/><path d="M19.5 11.5a3.2 3.2 0 010 5M11.5 7.5V5M8 7.5h7" stroke="#BA2F7D" strokeWidth="2" strokeLinecap="round"/><circle cx="9" cy="13.5" r="1.1" fill="#BA2F7D"/></svg>,
  car: () => <svg aria-hidden="true" width="26" height="26" viewBox="0 0 26 26" fill="none"><path d="M5 13l2.2-5.5h9.6L19 13" stroke="#406EB3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/><rect x="3" y="13" width="20" height="6" rx="2" stroke="#406EB3" strokeWidth="2"/><circle cx="8" cy="19" r="1.8" fill="#26478D"/><circle cx="18" cy="19" r="1.8" fill="#26478D"/></svg>,
  card: () => <svg aria-hidden="true" width="26" height="26" viewBox="0 0 26 26" fill="none"><rect x="3" y="6" width="20" height="14" rx="2.5" stroke="#982881" strokeWidth="2"/><path d="M3 10.5h20" stroke="#982881" strokeWidth="2"/><path d="M6.5 16h4" stroke="#632678" strokeWidth="2" strokeLinecap="round"/></svg>,
}

const HelpIco = {
  freeze: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M10 2v16M3.1 6l13.8 8M3.1 14l13.8-8" stroke="var(--color-pink-400)" strokeWidth="1.6" strokeLinecap="round"/><path d="M10 2l-2 2m2-2l2 2M3.1 6l.3 2.7M3.1 6l2.6-.9M16.9 14l-2.6.9m2.6-.9l-.3-2.7M3.1 14l2.6.9M3.1 14l-.3-2.7M16.9 6l-.3 2.7M16.9 6l-2.6-.9M10 18l-2-2m2 2l2-2" stroke="var(--color-pink-400)" strokeWidth="1.4" strokeLinecap="round"/></svg>,
  dispute: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M5 2.5h7l4 4v11a1 1 0 01-1 1H5a1 1 0 01-1-1v-14a1 1 0 011-1z" stroke="var(--color-pink-400)" strokeWidth="1.5" strokeLinejoin="round"/><path d="M12 2.5v4h4" stroke="var(--color-pink-400)" strokeWidth="1.5" strokeLinejoin="round"/><path d="M6.8 12.2l1.7 1.7 3.4-3.6" stroke="var(--color-pink-400)" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  fraud: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M10 2l6 2.2v4.3c0 3.7-2.6 6.4-6 7.7-3.4-1.3-6-4-6-7.7V4.2L10 2z" stroke="var(--color-pink-400)" strokeWidth="1.5" strokeLinejoin="round"/><path d="M10 7v3.2M10 12.6v.1" stroke="var(--color-pink-400)" strokeWidth="1.6" strokeLinecap="round"/></svg>,
}

const Social = {
  fb: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="currentColor"><path d="M11.5 18v-7h2.3l.4-2.7h-2.7V6.6c0-.8.2-1.3 1.4-1.3h1.4V2.9c-.7-.1-1.4-.1-2.1-.1-2.1 0-3.5 1.3-3.5 3.6v2H6.5V11h2.6v7h2.4z"/></svg>,
  x: () => <svg aria-hidden="true" width="18" height="18" viewBox="0 0 20 20" fill="currentColor"><path d="M15.3 2h2.9l-6.3 7.2L19.5 18h-5.8l-4.5-5.9L3.9 18H1l6.8-7.7L1 2h5.9l4.1 5.4L15.3 2zm-1 14.3h1.6L6.3 3.6H4.6l9.7 12.7z"/></svg>,
  ig: () => <svg aria-hidden="true" width="20" height="20" viewBox="0 0 20 20" fill="none"><rect x="3" y="3" width="14" height="14" rx="4.5" stroke="currentColor" strokeWidth="1.6"/><circle cx="10" cy="10" r="3.4" stroke="currentColor" strokeWidth="1.6"/><circle cx="14.2" cy="5.8" r="1" fill="currentColor"/></svg>,
  yt: () => <svg aria-hidden="true" width="22" height="22" viewBox="0 0 22 22" fill="none"><rect x="3" y="6" width="16" height="10" rx="3" stroke="currentColor" strokeWidth="1.6"/><path d="M9.5 9l3.5 2-3.5 2V9z" fill="currentColor"/></svg>,
}
...
function RocketArt() {
  return (
    <svg aria-hidden="true" width="144" height="78" viewBox="0 0 144 78" style={{ display: 'block', marginTop: 8, borderRadius: '0 0 8px 8px' }}>
...
function FauxQR() {
  ...
  return <svg aria-hidden="true" width="105" height="105" viewBox={`0 0 ${N * 5} ${N * 5}`}>{cells}</svg>
}

function DiamondDeco({ size = 340, strokeWidth = 2, style = {} }) {
  const cx = size / 2, cy = size / 2
  return (
    <svg aria-hidden="true" width={size} height={size} viewBox={`0 0 ${size} ${size}`} fill="none" style={{ pointerEvents: 'none', ...style }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, padding: '28px 0', borderTop: '1px solid var(--color-neutral-200)', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
            ...
            <div style={{ display: 'flex', gap: 14, color: 'var(--color-neutral-700)' }}>
              <a className="lnk" aria-label="Experian on Facebook"><Social.fb /></a><a className="lnk" aria-label="Experian on X"><Social.x /></a><a className="lnk" aria-label="Experian on Instagram"><Social.ig /></a><a className="lnk" aria-label="Experian on YouTube"><Social.yt /></a>
            </div>
          </div>
        </div>
